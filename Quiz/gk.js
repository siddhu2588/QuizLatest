...
function pc(){
    anychart.onDocumentReady(function() {
        ...
        // set the data
        var data = [
            {x: "Basic General Knowledge", value: gp},
            {x: "General Science", value: sp},
            {x: "Indian Politics", value: ap},
            {x: "World Geography", value: jp},
            {x: "Chemistry", value: ip},
            {x: "Failure", value: f}
...
function para(){
    ...
    document.getElementById("para").innerHTML= "You have scored " + percent + "% in the test you have appeared for. This test was divided into different parts, which are as follows: <br> <br>* Basic General Knowledge <br>* General Science <br>* Indian Politics <br>* World Geography <br>* Chemistry <br><br> As " + g + " questions are correct in your 'Basic General Knowledge' section, hence you have scored "+ gp +"% in it. Similarly you have scored "+ sp + "% , "+ ap+ "%, " + jp +"%, and "+ ip + "% in General Science, Indian Politics, World Geography and Chemistry respectively. For the pictorial representation, you can refer to the pie chart shown above.<br><br> We suggest you to appear for the test again for more improvement. Moreover, you can also refer to different sections of the quiz." 
