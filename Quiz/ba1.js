...
function pc(){
    anychart.onDocumentReady(function() {
        ...
        // set the data
        var data = [
            {x: "Problem on Numbers", value: gp},
            {x: "Simplification", value: sp},
            {x: "Series", value: ap},
            {x: "Clock", value: jp},
            {x: "Races & Games", value: ip},
            {x: "Failure", value: f}
...
function para(){
    ...
    document.getElementById("para").innerHTML= "You have scored " + percent + "% in the test you have appeared for. This test was divided into different parts, which are as follows: <br> <br>* Problem on Numbers <br>* Simplification <br>* Series <br>* Clock <br>* Races & Games <br><br> As " + g + " questions are correct in your 'Problems on Numbers' section, hence you have scored "+ gp +"% in it. Similarly you have scored "+ sp + "% , "+ ap+ "%, " + jp +"%, and "+ ip + "% in Simplification, Series, Clock and Races & Games respectively. For the pictorial representation, you can refer to the pie chart shown above.<br><br> We suggest you to appear for the test again for more improvement. Moreover, you can also refer to different sections of the quiz." 
