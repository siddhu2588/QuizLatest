...
function para(){
        ...
        // alert("gp is" + gp + "ap is " + ap + " sp is" + sp + "jp is "+ jp + "ip is" + ip); 
    ...
    document.getElementById("para").innerHTML= "You have scored " + percent + "% in the test you have appeared for. This test was divided into different parts, which are as follows: <br> <br>* Simple Interest <br>* Profit & Loss <br>* Percentage <br>* Calendar <br>* Average <br><br> As " + g + " questions are correct in your 'Simple Interest' section, hence you have scored "+ gp +"% in it. Similarly you have scored "+ sp + "% , "+ ap+ "%, " + jp +"%, and "+ ip + "% in Profit & Loss, Percentage, Calendar and Average respectively. For the pictorial representation, you can refer to the pie chart shown above.<br><br> We suggest you to appear for the test again for more improvement. Moreover, you can also refer to different sections of the quiz." 
