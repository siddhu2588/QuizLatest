...
// };
 ...
 function start() {
    //  document.getElementById("corrans").style.display = "none";
     ...
     document.getElementById("gramtest").style.display = "none";
     document.getElementById("syntest").style.display = "none";
     document.getElementById("antotest").style.display = "none";
     document.getElementById("jumbtest").style.display = "none";
     document.getElementById("idiomtest").style.display = "none";
...
function pc(){
    anychart.onDocumentReady(function() {
        ...
        var data = [
            ...
            {x: "Synonymn", value: sp},
            {x: "Antonymn", value: ap},
            {x: "Jumbled Sentences", value: jp},
            {x: "Idiom/Phrases", value: ip},
            {x: "Failure", value: f}
...
function para(){
    ...
    document.getElementById("para").innerHTML= "You have scored " + percent + "% in the test you have appeared for. This test was divided into different parts, which are as follows: <br> *Grammar <br>*Synonymns <br>*Antonymns <br>*Jumbuled Sentences <br>*Idiom/Phrases. <br><br> As " + g + " questions are correct in your 'Grammar' section, hence, you have scored "+ gp +"% in it. Similarly you have scored "+ sp + "% , "+ ap+ "%, " + jp +"%, and "+ ip + "% in Synonymns, Antonymns, Jumbuled Sentences and Idiom/Phrases respectively. For the pictorial representation, you can refer to the pie chart shown above.<br><br> We suggest you to appear for the test again for more improvement. Moreover, you can also refer to different sections of the quiz." 
