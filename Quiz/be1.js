...
// };
 ...
 function start() {
    //  document.getElementById("corrans").style.display = "none";
     ...
     document.getElementById("owstest").style.display = "none";
     document.getElementById("sentcorrtest").style.display = "none";
     document.getElementById("covtest").style.display = "none";
     document.getElementById("verbtest").style.display = "none";
     document.getElementById("selectingwordstest").style.display = "none";
...
function pc(){
    anychart.onDocumentReady(function() {
        ...
        // set the data
        var data = [
            {x: "One Word Substitutes", value: gp},
            {x: "Sentence Correction", value: sp},
            {x: "Change of Voice", value: ap},
            {x: "Verbal Analogies", value: jp},
            {x: "Selecting Words", value: ip},
            {x: "Failure", value: f}
...
function para(){
    ...
    document.getElementById("para").innerHTML= "You have scored " + percent + "% in the test you have appeared for. This test was divided into different parts, which are as follows: <br> * One Word Substitute <br>* Sentence Correction <br>* Change of Voice <br>* Verbal Analogies <br>* Selecting Words. <br><br> As " + g + " questions are correct in your 'One Word Substitute' section, hence you have scored "+ gp +"% in it. Similarly you have scored "+ sp + "% , "+ ap+ "%, " + jp +"%, and "+ ip + "% in Sentence Correction, Change of Voice, Verbal Analogies and Selecting Words respectively. For the pictorial representation, you can refer to the pie chart shown above.<br><br> We suggest you to appear for the test again for more improvement. Moreover, you can also refer to different sections of the quiz." 
